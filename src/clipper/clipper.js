...
Clipper.newNote = function(){
    chrome.windows.create({
        url : Clipper.getServer() + "lumennote/noteCreate.app",
        width : 640,
        height: 480
    });
};
...
Clipper.clipURL = function(data){
    ...
    chrome.windows.create({
        url : Clipper.getServer() + "lumennote/noteCreate.app?url="+url,
        width : 640,
        height: 480
    });
};
...
Clipper.clipImage = function(data){
    ...
    Clipper.getBase64Image(url, function(image){
        chrome.windows.create({
            url : Clipper.getServer() + "lumennote/noteCreate.app?image="+image,
            width : 640,
            height: 480
        });
    });
